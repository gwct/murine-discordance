...
if(feature=="genes"){
  infile = here("summary-data", "02-genomic-windows", "feature-beds", "mm10-genes.bed")
  logfile = "logs/coord-query-genes-"
  cols = c("chr", "start", "end", "ids", "score", "strand")
}else if(feature=="coding-genes"){
  infile = here("summary-data", "02-genomic-windows", "feature-beds", "mm10-coding-genes.bed")
  logfile = "logs/coord-query-coding-genes-"
  #logfile = "test-"
  cols = c("chr", "start", "end", "ids", "score", "strand")
}else if(feature=="ps"){
  infile = here("summary-data", "02-genomic-windows", "feature-beds", "mm10-ps-genes-all-gt.bed")
  logfile = "logs/coord-query-ps-genes-all-gt-"
  #infile = "../../../cds/data/test.bed"
  #logfile = "test-"
  cols = c("chr", "start", "end", "ids", "score", "strand")
}else if(feature=="uces"){
  infile = here("summary-data", "02-genomic-windows", "feature-beds", "mm10-uce.bed")
  logfile = "logs/coord-query-uces-"
  cols = c("chr", "start", "end", "gid", "score", "strand")
}else if(feature=="hotspots"){
  infile = here("summary-data", "02-genomic-windows", "recombination-markers", "smagulova-hotspots", "Smagulova_2010-hotspots-mm10.bed")
  logfile = "logs/coord-query-hotspots-"
...
if(read_data){
  ...
  window_file = here("summary-data", "02-genomic-windows", paste0(window_size_kb, "kb-0.5-0.5-", marker_window_size, "mb-topo-counts.csv"))
  windows = read.csv(window_file, header=T, comment.char="#")
...
for(chr_coords in split_coords){
  ...
  outfile = here("data", "02-genomic-windows", "coord-query", paste0(feature, "-", flank_interval_mb, "-Mb.bed.", chrome, ".dists"))
  outfile_random = here("data", "02-genomic-windows", "coord-query", paste0(feature, "-", flank_interval_mb, "-Mb.bed.", chrome, ".random"))
