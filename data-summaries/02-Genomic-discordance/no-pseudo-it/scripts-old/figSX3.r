...
summary_data$chrome = factor(summary_data$chrome, levels=rev(c("chr1", "chr2", "chr3", "chr4", "chr5", "chr6", "chr7", "chr8", "chr9", "chr10", "chr11", "chr12", "chr13", "chr14", "chr15", "chr16", "chr17", "chr18", "chr19", "chrX")))
...
if(save_fig){
  fig3file = "../figs/supp/figSX-xchrome.png"
