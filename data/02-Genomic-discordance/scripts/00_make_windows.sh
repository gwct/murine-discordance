...
winsize="10000"
winsize_kb="10"
outbed="/mnt/beegfs/gt156213e/penn-genomes/windows/pseudo/bed/mm10-${winsize_kb}kb-initial.bed"
outbed_win="/mnt/beegfs/gt156213e/penn-genomes/windows/pseudo/bed/mm10-${winsize_kb}kb.bed"
outbed_rep="/mnt/beegfs/gt156213e/penn-genomes/windows/pseudo/bed/mm10-${winsize_kb}kb-repeat-coverage.bed"
